...
public class Computadora implements iArtefactosA{

    private int tiempoDeVida;
    private int precio;
    private String modelo;
    private String marca;
    private int threadMultiply=30+(int)(Math.random()*((50-30)+1)); //segundos a esperar

    public Computadora(int tiempoDeVida, int precio, String modelo, String marca) {
