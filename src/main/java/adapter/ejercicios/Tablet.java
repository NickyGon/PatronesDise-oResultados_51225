...
public class Tablet implements iArtefactosA{

    private int tiempoDeVida;
    private int precio;
    private String modelo;
    private String marca;
    private int threadMultiply=20+(int)(Math.random()*((45-20)+1)); //segundos a esperar

    public Tablet(int tiempoDeVida, int precio, String modelo, String marca) {
